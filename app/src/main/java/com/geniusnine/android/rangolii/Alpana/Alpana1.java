...
public class Alpana1 extends AppCompatActivity implements
    ...
    private BabyImages imageId;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_alpana1);
        ...
        viewPage.setOnPageChangeListener(Alpana1.this);
