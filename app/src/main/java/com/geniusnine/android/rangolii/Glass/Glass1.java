...
public class Glass1 extends AppCompatActivity implements
    ...
    private ElegantImages imageId;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_glass1);
        ...
        viewPage.setOnPageChangeListener(Glass1.this);
