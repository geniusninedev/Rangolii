...
public class Floating1 extends AppCompatActivity implements
    ...
    private EasterImages imageId;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_floating1);
        ...
        viewPage.setOnPageChangeListener(Floating1.this);
