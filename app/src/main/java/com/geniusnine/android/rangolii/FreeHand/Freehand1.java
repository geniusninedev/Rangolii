...
public class Freehand1 extends AppCompatActivity implements
    ...
    private AutumnImages imageId;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_freehand1);
        ...
        viewPage.setOnPageChangeListener(Freehand1.this);
