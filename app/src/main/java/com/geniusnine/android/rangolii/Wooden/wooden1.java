...
public class wooden1 extends AppCompatActivity implements
    ...
    private CartoonImages imageId;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wooden1);
        ...
        viewPage.setOnPageChangeListener(wooden1.this);
