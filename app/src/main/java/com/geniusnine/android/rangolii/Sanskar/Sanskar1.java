...
public class Sanskar1 extends AppCompatActivity implements
    ...
    private GalaxyImages imageId;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sanskar1);
        ...
        viewPage.setOnPageChangeListener(Sanskar1.this);
