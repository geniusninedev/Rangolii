...
public class Salt1 extends AppCompatActivity implements
    ...
    private WinterImages imageId;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_salt1);
        ...
        viewPage.setOnPageChangeListener(Salt1.this);
